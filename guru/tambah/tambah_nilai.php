            ...
            <div class="container mt-5 mb-5 d-flex justify-content-center">
                <div class="card px-1 py-4">
                    <div class="card-body">
                        ...
                        <form action="../../backend/nilai.php?aksi=tambah" method="POST">
                                ...
                                <div class="form-group">
									<label>Nilai</label>
									<input type="number" value="" class="form-control" name="nilai" required>
								</div>
                                <div class=" d-flex flex-column text-center px-5 mt-3 mb-3">
                                    ...
                                    <div class="inline text-center px-5 mt-3 mb-3"> 
                                        <a href="../skor-harian.php" class="btn btn-warning btn-md" name="create"><i class="fa fa-close"></i> Cancel</a>
